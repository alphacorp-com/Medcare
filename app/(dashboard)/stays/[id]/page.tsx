        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-slate-500 mt-1 flex items-center gap-3">
              <span className="font-semibold text-slate-700">Patient: {stay.patientName}</span>
              <span>&bull;</span>
              <span>Admitted: {stay.admissionDate}</span>
              <span>&bull;</span>
        ...
        <div className="col-span-3 flex flex-col gap-4 overflow-y-auto">
          <div className="bg-white rounded border border-slate-200 shadow-sm p-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                <div className="text-[10px] text-slate-500 mb-0.5">Arrival Mode</div>
          ...
          <div className="bg-red-50 rounded border border-red-100 shadow-sm p-4">
            <div className="text-[10px] font-bold text-red-800 uppercase tracking-widest mb-2 border-b border-red-200/50 pb-2">Chief Complaint</div>
          ...
          <Tabs defaultValue="timeline" className="w-full flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-auto bg-white p-0">
              ...
              <TabsContent value="orders" className="m-0 border-none outline-none p-6 text-center text-slate-500 text-xs">
                No active distinct orders found for this stay outside of protocol.
              </TabsContent>
            </div>
          </Tabs>
        </div>
